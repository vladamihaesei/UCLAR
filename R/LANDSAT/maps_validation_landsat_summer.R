...
rmis <- terra::rast("grids/LANDSAT/Copydata2/Iasi/summer/LC08_182027_20160618_algn.tif") -273.15
rorg <- terra::rast("grids/LANDSAT/data_2/Iasi/summer/LC08_182027_20160618_algn.tif") -273.15 #LT05_182027_20100125
#rorg[!is.na(rmis)] <- NA
rfill <- rts::read.rts("grids/LANDSAT/filled_validation/Iasi/summer")
rfill <- subset(rfill,"2018-06-08") -273.15
...
##### legenda culori 
rmean <- colorRampPalette(rev(c(brewer.pal(9,"RdYlBu")))[2:9], interpolate="linear")
brks.mean <- seq(23,46, by = 1.2)
...
png(paste0("png/LANDSAT/AIC_article/dineof_validation_summer",".png"), height = 1800, width = 2600, res = 220)
gg
dev.off()
system(paste0("convert -trim ", "png/LANDSAT/AIC_article/dineof_validation_summer",".png"," png/LANDSAT/AIC_article/dineof_validation_summer",".png"))
...
rorg[!is.na(rmis)] <- NA
rfill <- rts::read.rts("grids/LANDSAT/filled_validation/Iasi/summer")
rfill.sel <- subset(rfill,"2018-06-08") -273.15
rfill.sel[!is.na(rmis)] <- NA
...
png(paste0("png/LANDSAT/AIC_article/scatterplot_validation",".png"), height = 800, width = 1000, res = 230)
dns
dev.off()
system(paste0("convert -trim ", "png/LANDSAT/AIC_article/scatterplot_validation",".png"," png/MODIS/AIC_article/scatterplot_validation",".png"))
